...
/*
 * Controller : Web Server App에서 Request를 제일 먼저 받는 main Class이다
...
// java에서 제공하는 JDK를 상속받아서 대부분의 기능을 처리하고 꼭 필요한 기능만 구현을 하게된다.

// WebServlet Annotation을 가지고 있는 클래스는 Tomcat 에 의해서 관리되고
...
// 5. doGet() method의 코드를 재 정의(Overriding) 하여 서비스를 구현하게 된다.
...
public class MainController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("This is bokk Controller");
