...
/*
 * WebBrowser를 통해서 /hello/menu라는 요청이 오면 처리후
 * 응답할 클래스
 * HttpServlet 클래스
 * 
 * Web에서 /hello/menu/라는 요청이 들어오면 컨트롤러의 코드가
 * 반응하도록 설정
 */
...
public class MenuController extends HttpServlet{
	...
	// 컨트롤러가 반을할 때 실행될 method
	// Tomcat 호출하여 여러가지 정보를 전달해줄 method
	// Tomcat 이 전달하는 정보는 
	// HttpServletRequest, HttpServlet 클래스의 객체를 통해 받을 수 있다.
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("query String : " + queString);
...
//			out.println("도서대여 처리");
			...
			resp.sendRedirect("hello/hook/list");
